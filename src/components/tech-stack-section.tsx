...
const technologies = [
  { name: "React", icon: <SiReact aria-hidden="true" className="text-[#61DAFB]" /> },
  { name: "Next.js", icon: <SiNextdotjs aria-hidden="true" /> },
  { name: "TypeScript", icon: <SiTypescript aria-hidden="true" className="text-[#3178C6]" /> },
  { name: "JavaScript", icon: <SiJavascript aria-hidden="true" className="text-[#F7DF1E]" /> },
  { name: "Vue.js", icon: <SiVuedotjs aria-hidden="true" className="text-[#42B883]" /> },
  { name: "Tailwind CSS", icon: <SiTailwindcss aria-hidden="true" className="text-[#38BDF8]" /> },
  { name: "Node.js", icon: <SiNodedotjs aria-hidden="true" className="text-[#339933]" /> },
  { name: "PostgreSQL", icon: <SiPostgresql aria-hidden="true" className="text-[#4169E1]" /> },
  { name: "MongoDB", icon: <SiMongodb aria-hidden="true" className="text-[#47A248]" /> },
  { name: "MySQL", icon: <SiMysql aria-hidden="true" className="text-[#4479A1]" /> },
  { name: "Supabase", icon: <SiSupabase aria-hidden="true" className="text-[#3ECF8E]" /> },
  { name: "Firebase", icon: <SiFirebase aria-hidden="true" className="text-[#FFCA28]" /> },
  { name: "Git", icon: <SiGit aria-hidden="true" className="text-[#F05032]" /> },
  { name: "GitHub", icon: <SiGithub aria-hidden="true" /> },
  { name: "Netlify", icon: <SiNetlify aria-hidden="true" className="text-[#00C7B7]" /> },
  { name: "Vercel", icon: <SiVercel aria-hidden="true" /> },
  { name: "Docker", icon: <SiDocker aria-hidden="true" className="text-[#2496ED]" /> },
  { name: "Prisma", icon: <SiPrisma aria-hidden="true" className="text-[#2D3748]" /> },
  { name: "Neon", icon: <SiNeon aria-hidden="true" className="text-[#00E699]" /> },
  { name: "HTML5", icon: <SiHtml5 aria-hidden="true" className="text-[#E34F26]" /> },
  { name: "CSS3", icon: <SiCss aria-hidden="true" className="text-[#1572B6]" /> },
];
