...
export default function Footer() {
    return (
        <>
            <footer className="footer p-10 bg-base-200 text-base-content dark:bg-gray-800 dark:text-slate-50">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 bg-gradient-to-r from-green-500 to-blue-500">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Ashsajal<br />Providing reliable tech</p>
                </div>
